          ...
          {[
            {
              ...
              body: 'One person creates a league and shares the invite code with friends. Everyone joins before the auction starts. Each manager gets a budget of 50,000 coins to spend on players.',
              icon: '🏟',
            },
            {
              step: '2',
              title: 'The Auction Begins',
              body: 'Once the host clicks Start Auction, the system automatically nominates players one by one — starting with Elite players and working down through World Class, Quality, Rotation, and Depth tiers.',
              icon: '🎯',
            },
            {
              step: '3',
              title: 'Bidding on Players',
              body: 'When a player appears, you have 60 seconds to place the opening bid at the base price. Once someone bids, a 30-second countdown starts. Every new bid resets the timer. If no one bids in 30 seconds, the player is sold to the highest bidder.',
              icon: '💰',
            },
            {
              step: '4',
              title: 'Squad Rules',
              body: `You must build a squad of 15 players with minimum position requirements:\n• 2 Goalkeepers\n• 5 Defenders\n• 5 Midfielders\n• 3 Forwards\n\nYou cannot bid on a player that would cause you to exceed position limits or fill your squad beyond 15.`,
              icon: '📋',
            },
            {
              step: '5',
            ...
            },
            {
              step: '6',
              title: 'Leaderboard',
              body: 'The leaderboard updates automatically after each World Cup match. Your total points are the sum of all your players\' performances across the entire tournament. The manager with the most points when the World Cup ends wins.',
              icon: '🏆',
            },
          ].map(item => (
