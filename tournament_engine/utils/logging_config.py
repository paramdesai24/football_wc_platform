"""
Centralized Logging Configuration for Tournament Engine
=========================================================
...
def setup_logging(name: str = "tournament", level: int = logging.INFO) -> logging.Logger:
    """
    ...
    if not _LOGGING_INITIALIZED:
        ...
        try:
            ...
            log_file = LOGS_DIR / "tournament_engine.log"
